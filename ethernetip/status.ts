...
export const PRODUCT_TYPES = {
  ..._PRODUCT_TYPES,
  ...Object.fromEntries(Object.entries(_PRODUCT_TYPES).map(([k, v]) => [v, k])),
};
...
const _VENDORS = {
  ...
  581:
    "Norgren Automation Solutions, LLC (previously Syron Engineering & Manufacturing, Inc.)",
  ...
  1326: "Badger Meter",
  1328:
    "Fisher-Rosemount Systems, Inc. doing business as Process Systems & Solutions",
...
export const VENDORS = {
  ..._VENDORS,
  ...Object.fromEntries(Object.entries(_VENDORS).map(([k, v]) => [v, k])),
};
